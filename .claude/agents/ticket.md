...
4. Message the lead with your implementation plan — **wait for approval before writing code**
...
- Long running background agents should be used to keep tickets and PRs updated.

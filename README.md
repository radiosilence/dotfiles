...
These live in `scripts/` as zsh. They share output helpers in `scripts/lib/common.zsh`
and declare their interface with [zarg](zsh-plugins/zarg/README.md), which derives

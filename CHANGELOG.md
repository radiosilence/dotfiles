...
- All 39 relative `source "${0:A:h:h}/..."` lines are gone. A script now says what it wants and nothing about where it lives: `autoload -Uz zarg_init zarg_flag zarg_go _dt_head`
